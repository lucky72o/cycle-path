        ...
        <div className='mx-auto max-w-8xl px-6 lg:px-8'>
          <div className='lg:mb-18 mx-auto max-w-3xl text-center'>
            <h1 className='text-5xl font-bold text-foreground sm:text-6xl'>
              Take Charge of Your <span className='italic'>Fertility</span> with{' '}
              <span className='text-gradient-primary'>Natural Family Planning</span>
            </h1>
            <p className='mt-6 mx-auto max-w-2xl text-lg leading-8 text-muted-foreground'>
              Track your basal body temperature, cervical fluid, and fertility signs to understand your cycle, predict ovulation, and take control of your reproductive health naturally.
            </p>
